...
class Dokumentasi extends CI_Controller
{
	...
	function caridok()
	{
		...
		$array = array(
		  1 => array("0",'Dokumentasi MFAS-WEB-Juni 2017'),
		);
	...
	function print()
	{
		...
		// 	$hasil = array(
		// 		'sukses'	=> true,
		// 		'url'		=> base_url().'uploads/Dokumentasi MFAS-WEB-Juni 2017.pdf',
		// 		'title'		=> Dokumentasi MFAS-WEB-Juni 2017.pdf,
		...
		$hasil = array(
				'sukses'	=> true,
				'url'		=> base_url().'uploads/Dokumentasi MFAS-WEB-Juni 2017.pdf',
				'title'		=> 'Dokumentasi MFAS-WEB-Juni 2017',
				'hasil'		=> 'Printing Success'
			);
			echo json_encode($hasil);
