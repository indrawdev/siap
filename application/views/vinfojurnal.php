...
<head>
	...
	<script type="text/javascript">
		var vDeptCd = '<?php echo $this->session->userdata('gDept')?>';
		var vCount = '<?php echo $this->session->userdata('gCount')?>';
	...
	<script type="text/javascript" src="<?php echo config_item('base_js');?>infojurnal.js?cb=<?php echo time()?>"></script>
</head>
<html>