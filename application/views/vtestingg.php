...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo config_item('base_css');?>example.css">
	...
	<script type="text/javascript" src="<?php echo config_item('base_js');?>testing.js?cb=<?php echo time()?>"></script>
</head>
<html>
