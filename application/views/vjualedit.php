...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo config_item('base_css');?>button.css">
	...
	<script type="text/javascript" src="<?php echo config_item('base_js');?>jualedit.js?cb=<?php echo time()?>"></script>
</head>
</html>