...
<head>
	...
	<link rel="icon" type="image/ico" href="<?php echo config_item('base_img');?>mfas.ico">
	...
	<script type="text/javascript" src="<?php echo config_item('base_js');?>apkkonsumen.js?cb=<?php echo time()?>"></script>
	<style>
		 .x-btn-left {
    float: left;
}
