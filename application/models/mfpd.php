...
class Mfpd extends CI_Model
{
	...
	function ambilDataDealer($tgl1,$tgl2,$kodsup,$nomsup)
	{
		...
		$xSQL = ("
			SELECT d.fs_nama_dealer,b.kodelk,b.nomdel,b.polpen,b.jenpiu,b.nompjb,b.nampem,a.lamovd,a.outgrs,a.outnet,a.ovdgrs,a.ovdnet,b.tglstj  FROM tx_arpjb b LEFT JOIN tm_dealer d on d.fs_kode_dealer1=b.kodsup and d.fs_kode_dealer2=b.nomsup LEFT JOIN tx_arovdd a ON a.nompjb=b.nompjb AND a.kodelk=b.kodelk AND a.nomdel=b.nomdel AND a.polpen=b.polpen AND a.jenpiu=b.jenpiu   WHERE b.tglstj >= '".trim($tgl1)."'
	...
	function ambilDataSurveyor($tgl1,$tgl2,$ptgsvy,$kodelk)
	{
		...
		$xSQL = ("
			SELECT b.kodelk,b.nomdel,b.polpen,b.jenpiu,b.nompjb,b.nampem,a.lamovd,a.outgrs,a.outnet,a.ovdgrs,a.ovdnet,b.tglstj  FROM tx_arpjb b LEFT JOIN tx_arovdd a ON a.nompjb=b.nompjb AND a.kodelk=b.kodelk AND a.nomdel=b.nomdel AND a.polpen=b.polpen AND a.jenpiu=b.jenpiu LEFT JOIN tx_arapk d ON b.nompjb=d.nompjb AND b.kodelk=d.kodelk AND b.nomdel=d.nomdel AND b.polpen=d.polpen AND b.jenpiu=d.jenpiu WHERE b.tglstj >= '".trim($tgl1)."'
				AND	b.tglstj <= '".trim($tgl2)."' AND b.kodekr='".$kodelk."' and d.ptgsvy='".$ptgsvy."'");
	...
	function ambilReport($tgl1,$tgl2,$kode_cabang)
	{
		...
		if ($kode_cabang <> '')
		{
			...
			SELECT b.kodsup,b.nomsup,d.fs_nama_dealer,COUNT(b.recoid) as penjualan,b.kodelk,b.nomdel,b.polpen,b.jenpiu,b.nompjb  FROM tx_arpjb b LEFT JOIN tm_dealer d on d.fs_kode_dealer1=b.kodsup and d.fs_kode_dealer2=b.nomsup  WHERE b.tglstj BETWEEN '".trim($tgl1)."'
				AND	'".trim($tgl2)."' AND b.kodekr='".$kode_cabang."'  GROUP BY CONCAT(b.kodsup,'',b.nomsup)");
	...
	function ambilReports($tgl1,$tgl2,$kode_cabang)
	{
		...
		if ($kode_cabang <> 0)
		{
			...
			SELECT b.kodsup,b.nomsup,d.fs_nama_dealer,COUNT(b.recoid) as penjualan,b.kodelk,b.nomdel,b.polpen,b.jenpiu,b.nompjb,b.nampem,a.lamovd,a.outgrs,a.outnet,a.ovdgrs,a.ovdnet  FROM tx_arpjb b LEFT JOIN tm_dealer d on d.fs_kode_dealer1=b.kodsup and d.fs_kode_dealer2=b.nomsup LEFT JOIN tx_arovdd a ON a.nompjb=b.nompjb AND a.kodelk=b.kodelk AND a.nomdel=b.nomdel AND a.polpen=b.polpen AND a.jenpiu=b.jenpiu AND  b.tglstj >= '".trim($tgl1)."'
				AND	b.tglstj <= '".trim($tgl2)."' AND b.kodekr='".$kode_cabang."'  GROUP BY CONCAT(b.kodsup,'',b.nomsup)");
	...
	function ambilReportSvy($tgl1,$tgl2,$kode_cabang)
	{
		...
		if ($kode_cabang <> '')
		{
			...
			$xSQL = ("
			SELECT b.ptgsvy,COUNT(b.recoid) as penjualan,a.kodelk,a.nomdel,a.polpen,a.jenpiu,b.nompjb  FROM tx_arapk b LEFT JOIN tx_arpjb a ON a.nompjb=b.nompjb AND a.kodelk=b.kodelk WHERE a.tglstj >= '".trim($tgl1)."'
				AND	a.tglstj <= '".trim($tgl2)."' AND a.kodekr='".$kode_cabang."' GROUP BY b.ptgsvy");

		}else {

			$xSQL = ("
			SELECT b.ptgsvy,COUNT(b.recoid) as penjualan,a.kodelk,a.nomdel,a.polpen,a.jenpiu,a.nompjb  FROM tx_arapk b LEFT JOIN tx_arpjb a ON a.nompjb=b.nompjb AND a.kodelk=b.kodelk WHERE a.tglstj >= '".trim($tgl1)."'
					AND	a.tglstj <= '".trim($tgl2)."' GROUP BY b.ptgsvy");
	...
	function ambilReportSvy2($tgl1,$tgl2,$kode_cabang)
	{
