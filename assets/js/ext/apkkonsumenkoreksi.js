...
Ext.onReady(function() {
	...
	function PremiNett() {
		...
		var assgros = Ext.getCmp('txtPremiGros').getValue();
		...
		},
		{
			...
			items: [
			{
								...
								handler: function() {
									...
									store.each(function(record, idx) {
										var xtext = record.get('fs_nama_perluasan').trim();
										...
										if (xtext == xprod) {
											Ext.MessageBox.show({
												...
												closable: false,
												icon: Ext.Msg.WARNING,
												msg: 'Jenis Perluasan already exists, add Perluasan cancel!!',
												title: 'IDS'
											});
											xlanjut = false;
										}
			...
			itemdblclick: function(grid, record)
			{
				...
				var kondisifix = kondisi.substring(1, 2);
					...
					if(kondisifix=='U'){
						...
						var combo2 = Ext.ComponentQuery.query('#txtNoPol')[0];
	...
	var checktjh = {
		...
		change : {
		    fn : function(checkbox, checked){
		    	...
		    	if(checked==true){
		    		var tjh =  Ext.getCmp('txtTjh2').getValue();

		    		Ext.getCmp('txtTjh').setValue(tjh);	
		    	}
	...
	*/
	...
	var txtNilaiCair = {
		border:false,
     	...
     	labelStyle:'font-weight:bold;margin-left:-30px;',
	...
	function fnSimpan() {
		...
		Ext.Ajax.request({
			...
			params: {
				...
				'fs_npwp1': Ext.getCmp('txtNoNpwp').getValue(),
				'fs_npwp2': Ext.getCmp('txtNoNpwp2').getValue(),
				'fs_npwp3': Ext.getCmp('txtNoNpwp3').getValue(),
				'fs_npwp4': Ext.getCmp('txtNoNpwp4').getValue(),
				'fs_npwp5': Ext.getCmp('txtNoNpwp5').getValue(),
				'fs_npwp6': Ext.getCmp('txtNoNpwp6').getValue(),
				...
				'fs_kode_wilayah_no_polisi': Ext.getCmp('txtNoPol').getValue(),
				...
				'fs_angsuran_dimuka_potong_pencairan': Ext.getCmp('txtTotalDp').getValue(),
