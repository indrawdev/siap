...
Ext.onReady(function() {
	...
	var grupTrxDok = Ext.create('Ext.data.Store', {
		autoLoad: true,
		fields: [
	...
	var cboDok = {
		...
		afterLabelTextTpl: required,
		anchor: '95%',
		displayField: 'fs_nama_dokumen',
		valueField: 'fs_kode_dokumen',
		emptyText: 'Enter an Doc',
		fieldLabel: 'Nama Dokumen',
		id: 'cboDok',
		name: 'cboDok',
		...
		Ext.Ajax.request({
			...
			success: function(response) {
				...
				if (xtext.sukses === true) {
					...
					popUp.add({html: '<iframe height="650", width="942" src="'+ url +'"></iframe>'});
	                popUp.show();
					fnReset();
				}
			},
