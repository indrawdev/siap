...
Ext.onReady(function() {
	...
	var updateCronJob = function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: 'notification/support',
			success: function(response) {
				var xtext = Ext.decode(response.responseText);
				if (xtext.sukses === true) {
					var xhtml = '<div class="support"><span class="icon"><span class="blank-avatar"></span></span><div class="text"><div class="title">'+ xtext.data.fs_name +'</div><div class="desc">'+ xtext.data.fn_phone +'</div></div></div>';
					Ext.create('widget.uxNotification', {
						title: 'Technical Support MFAS',
						position: 'br',
