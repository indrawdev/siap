...
Ext.onReady(function() {
	...
	var gridRetail = Ext.create('Ext.grid.Panel', {
		...
		listeners: {
			itemdblclick: function(grid, record) {
				...
				Ext.getCmp('txtCatAnalisaCabang').setValue(record.get('fs_catatan_analisa_cabang'));
	...
	var txtCatAnalisaCabang = {
		anchor: '100%',
		height : 80,
		fieldStyle: 'background-color: #eee; background-image: none;',
		readOnly: true,
		fieldLabel: 'Catatan Analisa Cabang',
		id: 'txtCatAnalisaCabang',
		name: 'txtCatAnalisaCabang',
		xtype: 'textareafield',
	};
	...
	var txtCatAnalisa = {
		...
		anchor: '100%',
		height : 80,
		fieldLabel: 'Catatan Analisa Pusat',
		id: 'txtCatAnalisa',
		name: 'txtCatAnalisa',
		xtype: 'textareafield',
	};
	...
	function fnCekSave()
	{
		if (this.up('form').getForm().isValid()) {
			...
			var xkdcabang = Ext.getCmp('txtKdCab').getValue();
