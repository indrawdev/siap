...
Ext.onReady(function() {
	...
	Ext.define('DataGridTgl2', {
		...
		fields: [
			...
			{name: 'ospokok', type: 'string'},
			{name: 'ospiu', type: 'string'},
			{name: 'tglovd', type: 'string'}
		]
	});
                   ...
                   handler: function(){
					...
					//alert("Terminate " + rec.get('firstname'));
                     var popUp = Ext.create('Ext.window.Window', {
							                	...
							                	popUp.add({html: '<iframe height="650" width="942" src="fpd/previewfpd/'+kodsup+'/'+nomsup+'/'+tglfix+'/'+tglfix2+'"></iframe>'});
							                	popUp.show();
                   }
                });
             }, 50);
             ...
             Ext.defer(function() {
                Ext.widget('button', {
                   ...
                   handler: function(){
                  	...
                  	var kategori = record.get('kategori');
					...
					//alert("Terminate " + rec.get('firstname'));
                     var popUp = Ext.create('Ext.window.Window', {
							                	...
							                	popUp.add({html: '<iframe height="650" width="942" src="aging/previewaging/'+kategori+'/'+tglfix+'/'+tglfix2+'/'+kode_cabang+'"></iframe>'});
							                	popUp.show();
                   }
                });
             }, 50);
                ...
                Ext.widget('button', {
                   ...
                   handler: function(){
					...
					var winInfo = Ext.create('Ext.window.Window', {
						...
						items: [],
						buttons: [{
							href: 'aging/downloadexcelaging/'+kategori+'/'+tglfix+'/'+tglfix2+'/'+kode_cabang,
							hrefTarget: '_blank',
							text: 'Download',
							xtype: 'button',
							handler: function() {
	...
	function fnCekSimpan2() {
		 ...
		 var popUp = Ext.create('Ext.window.Window', {
							                	...
							                	popUp.add({html: '<iframe height="650" width="942" src="aging/previewagingawal/'+tgl1+'/'+tgl2+'/'+kodecabang+'"></iframe>'});
							                	popUp.show();
	}
	     ...
	     if(kodecabang==''){
	     	var kodecabang = '0';
			   ...
			   var winInfo = Ext.create('Ext.window.Window', {
						...
						items: [], 
						buttons: [{
							href: 'aging/downloadagingawal/'+tgl1+'/'+tgl2+'/'+kodecabang,
							hrefTarget: '_blank',
							text: 'Download',
							xtype: 'button',
							handler: function() {
